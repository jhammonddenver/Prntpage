 ...
 <!-- Main content  : start -->
        <main class="page-content" id="app"> 
            ...
            <div class="properties" id="js-propertiesWrap" v-bind:class="active">
                <div class="row align-items-center justify-content-between mb-4 mb-lg-0">
                    <div class="col-12 col-xl-3">
                        <h2 class="page__title mt-1 mb-2">Properties</h2>
                    </div>

                    <div class="col-12 col-lg-8 col-xl-5 mt-3 mb-3 mt-xl-0 mb-xl-0 properties-sorted__wrap-list">
                        <div class="properties-sorted d-flex flex-column flex-sm-row">

                            <div class="filter-sorted-view d-flex">
                                <div class="select-description">Sort by:</div>
                                <div class="select-wrapper">
                                    <select class="select-control select-control_custom select-control_dm">
                                        <option value="value1" selected>First Tested</option>
                                        <option value="value2">First Tested</option>
                                        <option value="value3">First Tested</option>
                                    </select>
                                </div>
                            </div>

                            <div class="filter-sorted-view d-flex">
                                <div class="select-description">Period of submission:</div>
                                <div class="select-wrapper">
                                    <select class="select-control select-control_custom select-control_dm">
                                        <option value="valueAll" selected>All</option>
                                        <option value="value22">First Tested</option>
                                        <option value="value33">First Tested</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-xl-4">
                        <div class="properties-panel d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2">
                            <div class="search">
                ...
                <div class="row mb-5 flex-lg-nowrap">
                    <div class="col-12 col-lg filter-wrap">
                        <div class="filter" id="app-filter">
                            <div class="dropdown">
                                            ...
                                            <li>
                                                <div class="rg-slider">
                                                    <div class="rg-slider__slider">
                                                        ...
                                                        <i class="rg-slider__slider-amount amount-2">$390 000</i>
                                    ...
                                    <div class="filter-group">
                                        ...
                                        <ul class="filter-list">
                                            <li>
                                                ...
                                                <ul class="list-inline" >
                                                    <li v-for="(c, i) in checkedBeds" class="list-inline-item">
                                                        <div class="checkbox checkbox_num">
                                                            <label class="checkbox-label">
                                                                <input type="checkbox" class="checkbox-input" v-model="checkedBeds[i]" @change="onChangeBeds(i)">
                                                                <span class="checkbox-indicator">{{ i + 1 }}</span>
                                                            </label>
                                                        </div>
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="filter-group">
                                        ...
                                        <ul class="filter-list">
                                            <li>
                                                ...
                                                <ul class="list-inline" >
                                                    <li v-for="(c, i) in checkedBaths" class="list-inline-item">
                                                        <div class="checkbox checkbox_num">
                                                            <label class="checkbox-label">
                                                                <input type="checkbox" class="checkbox-input" v-model="checkedBaths[i]" :disabled="i === checkedBaths.length - 1" @change="onChangeBaths(i)">
                                                                <span class="checkbox-indicator">{{ i + 1 }}</span>
                                                            </label>
                                                        </div>
                                                    </li>
                    ...
                    <div class="col-12 col-lg">
                        <div class="row align-items-center">
                            <div class="col-12 col-xl filter-active d-flex align-items-center">
                            ...
                            <div class="col-12 col-xl properties-catalog-wrap properties-sorted__wrap-map mb-3 mb-xl-2">
                                <div class="properties-sorted d-flex flex-column flex-sm-row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-xl properties-catalog-wrap">
                                            ...
                                            <div class="d-flex flex-wrap flex-md-nowrap">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <div class="product-adress">
                                                        E Mississippi Ave, Denver, CO 80210 942
                                                    </div>
                                ...
                                <div class="row align-items-center justify-content-center mt-3">
                                    <div class="col-12 col-md-12 offset-xl-2 col-xl-8 text-center">
                                        <a href="#" class="filter-show-more">
                                            Show more
                                        </a>
                                    </div>
                                </div>
    ...
    <script>
        new Vue({
          ...
          data: {
            active: 'container',
            checkedBeds: [0,0,0,0,0],
            checkedBaths: [0,0,0,0,0]
          },
          // Functions we will be using.
            methods: {
                ...
                onChangeBeds: function(index) {
                  this.checkedBeds = Array(index + 1).fill(1).concat(Array(this.checkedBeds.length - index - 1).fill(0))
                },

                onChangeBaths: function(index) {
                  this.checkedBaths = Array(index + 1).fill(1).concat(Array(this.checkedBaths.length - index - 1).fill(0))
                }
            }
        });
