...
<meta name="twitter:image" content="https://prntpage.com/earth-logo.png" />
	...
	<script type="text/javascript" src="js/gmap-properties.js"></script>
     ...
     <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                     <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="pets-livestock-map.php">Properties</a></li>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-map" href="realestate.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-list" href="realestate-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Real Estate</h3> </center>
...
$sql2 = "SELECT * FROM homes WHERE listing_cat='Real Estate'";
...
<div class='col-12 d-flex flex-wrap flex-md-nowrap'>
                                        ...
                                        <div class='product-prev col-5'>  <strong>
                                            ...
                                            <div class='col-3'>
                                                <a class='btn btn-send' style='float:right' href='listing.php?id=".$row2["listing_id"]."
