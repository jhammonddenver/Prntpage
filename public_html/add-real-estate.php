        ...
        <main class="page-content"> 
            ...
            <div class="add-listing">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="page__title text-center">Add Real Estate</h2>
                        </div>
                    </div>
...
<form class="form" action="includes/new-real-estate.inc.php" method="post">

    <input type="hidden" name="housing_cat" class="form-control"  value="Real Estate">
...
Building</option>
    ...
    <input type="text" name="housing_purchase" class="form-control" placeholder="Enter Amount">
    </div> 
