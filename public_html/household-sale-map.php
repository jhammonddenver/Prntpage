                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-map" href="household-sale.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-list" href="household-sale-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Household</h3> </center>
...
<a href="#" class="col-1 btn btn-send" style="max-height:1.5rem;padding:0px"><font color="#fff" style="font-size=".09rem">Search</font></a>
    	...
    	<?php 
			require 'household-sale-class.php';
			$edu = new education;
...
$sql2 = "SELECT * FROM items WHERE type='Household'";
