...
?>
        ...
        <main class="page-content"> 
            ...
            <form action="includes/upload-transport-main.inc.php" method="post" enctype="multipart/form-data">
...
<button onclick="location.href='add-transport-finish.php'" type="button" class="btn btn-send">
     Finish</button>
