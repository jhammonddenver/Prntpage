                ...
                <div class="d-flex">
                    ...
                    <aside class="page-content-nav steps animated-fadeInLeft">
                        ...
                        <ul class="nav nav-tabs" id="myTabSteps" role="tablist">
                            ...
                            <li class="nav-item">
                                <a id="step-4-tab" class="nav-link d-flex save" data-toggle="tab" href="#step-4" aria-controls="step-4" aria-selected="false">
                    ...
                    <div class="page-content-view animated-fadeIn">
                        <div class="tab-content" id="myTabContentSteps">
                            ...
                            <div id="step-4" class="tab-pane animated-fadeIn active" role="tabpanel" aria-labelledby="step-4-tab">
                                ...
                                </div><!-- end of card for booking details -->
                                ...
                                <div class="card card-body px-4">
                                    <ul class="purchase-details">
                                        ...
                                        <li>
                                            <b>Accommodation Address:</b>
                                            <p>' . $add2. ', ' . $city . ', ' . $state . ' ' . $zip . '</p>
                                        </li>
                                        <li>
                                            <b>Travel Property</b>
                                            <p>' . $type . '</p>
                                ...
                                </div> <!-- end of card for purchase details -->
                                ...
                                <div class="card card-body px-4">
                                    ...
                                    <ul class="total-charged">
                                        <li>Card will be charged:</li>
                                        <li>$'.$total.'</li>
                                    </ul>

                                </div> <!-- end of card for payment details-->
...
<form class="form float-right" method="POST" action="stripe.php">
                                    ...
                                    <button style="margin-top:-30px" class="btn-payout" type="submit" name="step-5-btn" class="btn-next" href="check-out-step5.php?id='.$row3['id'].'">Place order</button>  </form>
        ...
        <div class="d-md-none row col-12">
         ...
         <h3 class="text-center">
                                ...
                                <div class="card card-body px-4">
                                    ...
                                    <hr>
                                    <ul class="charge-details">
                                        <li>$' . $int . ' x '.$nights.' nights = $'.$subTotal.'</li>
                                    ...
                                    <ul class="total-charged">
                                        <li>Card will be charged: $'.$total.'</li>
                                    </ul>

                                </div> <!-- end of card for payment details-->

                                <div class="nav-buttons">
                                     <button class="btn-back col-4 float-left mb-1 pb-1" onclick="goBack()">Back</button>
...
<form class="form " method="POST" action="stripe.php">
                                    ...
                                    <button style="margin-top:-30px"  type="submit" name="step-5-btn" class="btn-next col-4 float-left mb-1 ml-3" href="check-out-step5.php?id='.$row3['id'].'">Place order</button>  </form>
                                </div><!-- end of nav buttons -->
                            </div><!-- end of step-4 -->
