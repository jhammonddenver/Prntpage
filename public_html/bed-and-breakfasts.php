                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-12 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="bed-and-breakfasts.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="bed-and-breakfasts-map.php">Map</a>
                                </li>
                            </ul>
                 ...
                 <small>   <div class="col-12 col-md-8 filter-list">
...
<a href="#" class="col-6 col-md-1 btn btn-send"><font color="#fff">Search</font></a>
</small>
</div>
...
if ($result2->num_rows > 0) {
 ...
 <div class='catalog-item '>
           <div class='col-12 col-md-4 product d-flex flex-column flex-md-row flex-wrap flex-md-nowrap flex-xl-nowrap flex-lg-wrap'>
...
<div class='d-flex flex-wrap flex-md-nowrap col-12'>
                                        ...
                                        <div class='product-prev '>  
                                                          ...
                                                          <a class='col-1 btn btn-link'  href='bnb.php?id=".$row2["id"]."
                                                
                                                ' >View</a>
                                                <a  class='col-1 btn btn-link' href='mailto:". $row2["listing_contact_email"] . "'>Contact</a><br>
                                            ...
                                            " . $row2["name"]. "</strong><br>         
                                               ...
                                               <a href='bnb.php?id=".$row2["id"]."'<br>
                                                
                                                 
                                                   
                                                       <img alt='' style='max-width:350px; max-height:240px;' class='rounded img-fluid'  src='bnbs/photos/" . $row2["listing_main_photo"] . "'>
                                                          </a> 
                                                          <p>
                                                          " . $row2["listing_cat"]. "
                                                          </p>
                                                          
                                                          <p>" . $row2["listing_add2"]. " <br>
