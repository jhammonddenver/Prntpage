    ...
    <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                   ...
                   <li class="breadcrumb-item"><a href="#">Home</a></li>
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Masseuse</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="masseuse.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="masseuse-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Masseuse</h3> </center>
...
$sql2 = "SELECT * FROM services WHERE type='Masseuse'";
