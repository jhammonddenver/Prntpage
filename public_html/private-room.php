    ...
    <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="bed-and-breakfasts.php">BnBs</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Private Room</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="private-room.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="private-room-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Private Room</h3> </center>
...
<a href="#" class="col-1 btn btn-send"><font color="#fff">Search</font></a>
                          ...
                          <div class="row mb-0 flex-lg-nowrap">
                    <div class="col-3 ">
                        <div class="filter">
                            <div class="dropdown">
...
$sql2 = "SELECT * FROM bnbs WHERE listing_cat='Private Room'";
