                ...
                <div class="d-flex">
                    ...
                    <div class="page-content-view animated-fadeIn">
                        <div class="tab-content" id="myTabContentSteps">
                            ...
                            <div id="step-2" class="tab-pane animated-fadeIn active" role="tabpanel" aria-labelledby="step-2-tab">
                                <h4 class="text-center col-12">
                                    Provide all the necessary information that your
                                    Lodging host might need to know
                                </h4>

                                <form class="form col-12 px-4" action="includes/stp3.bnb.inc.php" method="post" name="booking-form">
                                    <label for "name">My name</label><br>
                                    <input type="text" id="name" name="name" value="'.$fn.' '.$ln.'" required><br>
                                    <label for "arrival">Time of arrival</label><br>
                                    <input type="text" id="arrival" name="arrival" placeholder="Time of arrival" required><br>
                                    <input type="text" id="guests" name="guests" placeholder="Additional guest names" ><br>
                                    <input type="tel" id="tel" name="tel" placeholder="My contact number" value="'.$phone.'" required><br>
                                    <input type="email" id="email" name="email" placeholder="My contact email" value="'.$email.'" required><br>
                                    <label for "guest-message">Guests message to host</label><br>
                                    <div class="write-message">
                                        <textarea id="message" class="guest-message" name="message">Enter additional information</textarea>
                                    </div>
                                

                                <div class="nav-buttons">
                                    <button class="btn-back" onclick="goBack()">Back</button>
                                     <button type="submit" name="step-3-btn" class="btn-next" href="check-out-step3.php?id='.$row3['id'].'">Next</button> </form>
