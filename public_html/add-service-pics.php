...
?>
        ...
        <main class="page-content"> 
            ...
            <form action="includes/upload-service-main.inc.php" method="post" enctype="multipart/form-data">
...
<button onclick="location.href='add-service-finish.php'" type="button" class="btn btn-send">
     Finish</button>
