...
<meta name="twitter:image" content="https://prntpage.com/earth-logo.png" />
	...
	<script type="text/javascript" src="js/gmap-roommates.js"></script>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-map" href="roommates.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-list" href="roommates-map.php">Map</a>
                                </li>
                            </ul>
