...
?>
        ...
        <main class="page-content"> 
            ...
            <form action="includes/upload-job-main.inc.php" method="post" enctype="multipart/form-data">
...
<button onclick="location.href='add-job-finish.php'" type="button" class="btn btn-send">
     Finish</button>
