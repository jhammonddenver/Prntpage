    ...
    <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                   ...
                   <li class="breadcrumb-item"><a href="#">Home</a></li>
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Travel Agents</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="travel-agents.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="travel-agents-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Travel Agents</h3> </center>
...
$sql2 = "SELECT * FROM services WHERE type='Travel Agents'";
...
<div class='d-flex flex-wrap flex-md-nowrap col-12'>
                                        ...
                                        <div class='product-prev '>  
                                                          ...
                                                          <a class='col-1 btn btn-link'  href='service.php?id=".$row2["id"]."
                                           ...
                                           <div class='product-name text-center'>
                                               ...
                                               <a href='service.php?id=".$row2["id"]."
                                                ...
                                                ' >
                                                     ...
                                                     <p>  <img alt='' style='width:350px; height:240px;' class='rounded img-fluid'  src='services/photos/" . $row2["main_pic"] . "'>
                                                          </a></p> 
