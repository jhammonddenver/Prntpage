        ...
        <main class="page-content"> 
            ...
            <div class="add-listing">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="page__title text-center">Add Vehicle For Rent</h2>
                        </div>
                    </div>
...
<form class="form" action="includes/new-transport.inc.php" method="post">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="transport_cat" class="form-control" value="Vehicles for Rent"></div> 
    ...
    <div class="form-group">
    <label class="label">Daily Price:</label><br>
    <input type="text" name="transport_daily" class="form-control" placeholder="Enter Amount">
    </div> 
