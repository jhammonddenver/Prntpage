   ...
   <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                  <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Hotels & Motels</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="hotels-motels.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="hotels-motels-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Hotels & Motels</h3> </center>
...
<a href="#" class="col-2 btn btn-send"><font color="#fff">Search</font></a>
  ...
  <div class="filter-group">
    	...
    	<?php 
			require 'hotels-motels-class.php';
			$edu = new education;
