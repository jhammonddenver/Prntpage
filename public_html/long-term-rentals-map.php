...
<meta name="twitter:image" content="https://prntpage.com/earth-logo.png" />
	...
	<script type="text/javascript" src="js/gmap-long-term-rentals.js"></script>
     ...
     <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                     <ol class="breadcrumb">
                       ...
                       <li class="breadcrumb-item active" aria-current="page">Long Term Rentals</li>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-map" href="long-term-rentals.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-list" href="long-term-rentals-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Long Term Rentals</h3> </center>
...
Building</option>
    	...
    	<?php 
			require 'long-term-rentals-class.php';
			$edu = new education;
...
$sql2 = "SELECT * FROM homes WHERE listing_cat='Long Term Rentals'";
                                        ...
                                        <div class='product-prev col-5'>  <strong>
                                            ...
                                            " . $row2["name"]. "</strong>
                                               <br>" . $row2["listing_cat"]. "<br>
                                                       ...
                                                       <img alt='' style='max-width:199px' class='rounded img-fluid'  src='properties/photos/" . $row2["listing_main_photo"] . "'>
                                            ...
                                            <div class='col-3'>
                                                <a class='btn btn-send' style='float:right' href='listing.php?id=".$row2["id"]."
