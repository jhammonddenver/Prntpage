    ...
    <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Skilled Trades</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="skilled-trades.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="skilled-trades-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Skilled Trades</h3> </center>
...
$sql2 = "SELECT * FROM jobs WHERE type='Skilled Trade'";
...
<div class='d-flex flex-wrap flex-md-nowrap col-12'>
                                        ...
                                        <div class='product-prev '>  
                                                          ...
                                                          <a class='col-1 btn btn-link'  href='job.php?id=".$row2["id"]."
                                           ...
                                           <div class='product-name text-center'>
                                               ...
                                               <a href='job.php?id=".$row2["id"]."
                                                ...
                                                ' >
                                                     ...
                                                     <p>  <img alt='' style='width:350px; height:240px;' class='rounded img-fluid'  src='jobs/photos/" . $row2["main_pic"] . "'>
                                                          </a></p> 
                                                          
                                                          <p>
                                                          " . $row2["position_title"]. "<br>
                                                          
                                                          
                                                         " . $row2["education"]. " <br> 
                                                 " . $row2["certifications"]. "         <br>" . $row2["level"]. "
                                                          <br>
