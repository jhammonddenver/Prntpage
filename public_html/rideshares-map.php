     ...
     <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                     <ol class="breadcrumb">
                       ...
                       <li class="breadcrumb-item active" aria-current="page">Rideshare</li>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-map" href="rideshares.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-list" href="rideshares-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Rideshare</h3> </center>
...
$sql2 = "SELECT * FROM transport WHERE cat='Rideshare'";
