                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="manufacturing.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="manufacturing-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Manufacturing</h3> </center>
...
$sql2 = "SELECT * FROM jobs WHERE type='Manufacturing'";
