...
$commission = $subTotal * .08;
$total = $subTotal + $commission + 0.01;
...
$row5cc = $result5cc->fetch_assoc();
    ...
    echo '
        ...
        <section class="page-tab">
            <div class="container">
                <h2 class=" col-12 page-tab-header animated-fadeIn">Complete Check Out</h2>
            </div>
        </section>
                ...
                <div class="d-flex">
                    ...
                    <aside class="page-content-nav steps animated-fadeInLeft">
                        ...
                        <ul class="nav nav-tabs" id="myTabSteps" role="tablist">
                            ...
                            <li class="nav-item">
                                <a id="step-2-tab" class="nav-link d-flex" data-toggle="tab" href="check-out-bnb-step2.php" >
                            ...
                            <li class="nav-item">
                                <a id="step-3-tab" class="nav-link d-flex" data-toggle="tab" href="#step-3" aria-controls="step-3" aria-selected="false">
                    ...
                    <div class="page-content-view animated-fadeIn">
                        <div class="tab-content" id="myTabContentSteps">
                            ...
                            <div id="step-1" class="tab-pane animated-fadeIn active" role="tabpanel" aria-labelledby="step-1-tab">
                                <div class="product-prev">
                                             <img  height="150" width="200" alt="" class=" col-12" src="bnbs/photos/' . $row3["listing_main_photo"] . '">
                                </div>
                                ...
                                <div class="product-body">
                                    ...
                                    <div class="product-price">
                                     ' . $row3["listing_nightly"] . ' a night.
                                    </div>

                                    <div class="product-address">
                                       ' . $row3["listing_add2"] . ', ' . $row3["listing_city"] . ', ' . $row3["listing_state"] . ' ' . $row3["listing_zip"] . '
                                    </div> 

                                    <div class="product-type">
                                        <ul>
                                            <li>' . $row3["listing_city"] . ' ' . $row3["listing_state"] . '</li>
                                            <li>' . $row3["type"] . '</li>
                                        </ul>
                                    </div>
                                </div><!-- end of product body -->     
                                ...
                                <div class="booking-details">
                                    ...
                                    <form class="form" method="POST" action="includes/stp2.bnb.inc.php">
                                    ...
                                    <input type="hidden" name="listingName" value="' . $row3["name"] . '">
                                        <input type="hidden" name="add1" value="' . $row3["listing_add1"] . '">
                                     <input type="hidden" name="add2" value="' . $row3["listing_add2"] . '">
                                      <input type="hidden" name="city" value="' . $row3["listing_city"] . '">
                                       <input type="hidden" name="state" value="' . $row3["listing_state"] . '">
                                        <input type="hidden" name="zip" value="' . $row3["listing_zip"] . '">
                                        <input type="hidden" name="cat" value="' . $row3["listing_cat"] . '">
                                    
                                    <input type="hidden" name="subTotal" value="'.$subTotal.'">
                                     <input type="hidden" name="lid" value="'.$lid2.'">
                                ...
                                <div class="nav-buttons">
                                    ...
                                    <button type="submit" name="step-2-btn" class="btn-next" >Next</button></form>
