...
?>
        ...
        <main class="page-content"> 
            ...
            <form action="includes/items-upload.inc.php" method="post" enctype="multipart/form-data">
...
<button onclick="location.href='add-item-finish.php'" type="button" class="btn btn-send">
     Finish</button>
