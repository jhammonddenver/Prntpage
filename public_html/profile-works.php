...
?>             
 ...
 $resultPostReply = $conn->query($sqlPostReply);
        ...
        $resultHiddenCheck = $conn->query($sqlHiddenCheck);
         ...
         $sqlDelDislikes =  "DELETE FROM hide_post WHERE uid='0'";
...
<button type="submit" class="col-3 col-lg-1 px-sm-2 px-3 py-1  btn float-left" name="like-submit"><i class="fas fa-thumbs-up"></i></button></form>
...
<button type="submit" class="col-3 col-lg-1 px-sm-2 px-3 py-1  btn float-left" name="unlike-submit"><i style="color:green" class=" fas fa-thumbs-up"></i></button></form>
...
<button type="submit" class="col-3 col-lg-1 px-3 py-1  btn float-left" name="dislike-submit"><i class="fas fa-thumbs-down"></i></button></form>
...
<button type="submit" class="col-3 col-lg-1 px-sm-2 px-3 py-1  btn float-left" name="undislike-submit"><i style="color:green" class=" fas fa-thumbs-down"></i></button></form>
...
<button type="submit" class="col-3 col-lg-1 px-3 py-1  btn float-left" name="love-submit"><i class="fas fa-heart"></i></button></form>
...
<button type="submit" class="col-3 col-lg-1 px-sm-2 px-3 py-1  btn float-left" name="unlove-submit"><i style="color:green" class=" fas fa-heart"></i></button></form>
...
<button type="submit" class="col-3 col-lg-1 px-3 py-1  btn float-left" name="share-submit"><i title="share" class="fas fa-retweet"></i></button></form>
        ...
        <input type="hidden" class="field" name="orig_body"
        id="orig_body" value="'."$postBody". '"></input>
         <button type="submit" class="col-3 col-lg-1 px-3 py-1  btn float-left" ><i title="reply" class="fas fa-reply"></i></button></form>
';
...
<button type="submit" class="col-3 col-lg-1 px-3 py-1  btn float-left" name="report-post-submit"><i title="report-post" class="fas fa-flag"></i></button></form>
...
<button type="submit" class="col-3 col-lg-1 px-sm-2 px-3 py-1  btn float-left" name="unflag-submit"><i style="color:green" class=" fas fa-flag"></i></button></form>
...
<button type="submit" class="col-3 col-lg-1 px-3 py-1  btn float-left" name="hide-post-submit"><i title="hide-post" class="fas fa-times"></i></button></form>
        ...
        $origPostReplier = $rowPostReplier['user_fn'].' '. $rowPostReplier['user_ln'];
     
        
        
        if ($deleted !=1 && $hiddenCheck == 'No' && $postid == $replyPostID){
            echo '
