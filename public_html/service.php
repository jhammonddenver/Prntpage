...
<?php
                    ...
                    <div class='row'>
                        <div class='col-md-6 col-lg-4 mb-3 mb-lg-0'>
                            <div class='product-prev'>
                                                           ...
                                                           <img alt='' class='rounded img-fluid col-12' src='services/photos/" . $row3["main_pic"] . "'>
                                          </div> </div>
       ...
       <div class=' col-sm-6 col-xs-12'>
            ...
            <p>
             ...
             ". $row3["disc"]. "
                   ...
                   <div style='max-height:160px' class='contact-badge  col-sm-12 col-md-2 col-lg-2 float-left'>
         ...
         <div class='agent-body '>
                                    ...
                                    <div class='col-12'><a href='profile.php?id=".$row3["uid"]."'>
                                        <img alt='' class='col-6 float-left' src='users/photos/" . $row4["user_photo"] . "'>
                                    </div>
  ...
  <a class='mt-2 btn btn-send' style='float:right' href='message.php?id=".$row3["uid"]."'><font color='#fff'>Hire</font>
                                 </a>
