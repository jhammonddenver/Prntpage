        ...
        <main class="page-content"> 
            ...
            <div class="add-listing">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="page__title text-center">Add Transport</h2>
                        </div>
                    </div>
...
<form class="form" action="includes/new-transport.inc.php" method="post">
  ...
  <a class="text-dark col-4 float-left" href="add-vehicle-rent.php"><i class="text-success ml-5 mr-5 fas fa-car fa-3x text-center content-justify-center"></i> <br>Vehicles for Rent
</a>
  <a class="text-dark col-4 float-left" href="add-vehicle-sale.php"><i class="text-success ml-3 mr-3 fas fa-car-side fa-3x text-center content-justify-center"></i> <br>Vehicles for Sale
</a>
  <a class="text-dark col-4 float-left" href="add-rideshare.php"><i class="text-success ml-3 mr-3 fas fa-taxi fa-3x text-center content-justify-center"></i> <br>Rideshare
</a>
</ul>
