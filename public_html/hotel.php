...
$sql3 = "SELECT * FROM hotels WHERE id='$id'";
...
<?php
                    ...
                    <div class='row'>
                        <div class='col-md-6 col-lg-4 mb-3 mb-lg-0'>
                            <div class='product-prev'>
                                                           ...
                                                           <img alt='' class='rounded img-fluid col-12' src='hotels/photos/" . $row3["main_pic"] . "'>
                                          </div> </div>
        ...
        <div class='row' >
          <div class=' col-sm-6 col-xs-12'>
                                                    ...
                                                    $". $row3["nightly"]. " a day. <br>$". $row3["weekly"]. " a week. 
      <br>$". $row3["monthly"]. " a month.
       ...
       <div class=' col-sm-6 col-xs-12'>
            ...
            <p>
             ...
             ". $row3["disc"]. "
                   ...
                   <div style='height:400px' class='contact-badge  col-sm-12 col-md-2 col-lg-2 float-left'>
         ...
         <div class='agent-body '>
                                ...
                                <a class='col-12 mt-4 btn btn-success' href='message.php?id=".$row4["idUsers"]."'><font color='#fff'>Message</font></a><br>
 <a class='mt-4 col-12 btn btn-info' href='book-hotel.php?id=".$row3["id"]."'><font color='#fff'>Book</font></a>
