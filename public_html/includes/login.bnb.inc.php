      ...
      if ($row = mysqli_fetch_assoc($result)) {
        ...
        // Then if they DO match, then we know it is the correct user that is trying to log in!
          ...
          $_SESSION['bday'] = $row['user_bday'];
           $_SESSION['bmonth'] = $row['user_bmonth'];
            $_SESSION['byear'] = $row['user_byear'];
          ...
          $_SESSION['ul'] = $row['user_level'];
           $_SESSION['photo'] = $row['user_photo'];
            $_SESSION['user_from'] = $row['user_from'];
             $_SESSION['user_lives'] = $row['user_lives'];
           
           
          // Now the user is registered as logged in and we can now take them back to the front page! :)
          header("Location: ../bnb.php?id=$referid");
