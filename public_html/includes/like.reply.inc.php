...
$friendid = $_POST['friendid'];
  ...
  $sql =  "SELECT * FROM post_reply WHERE id='$postToReplyToID'";
 $result = $conn->query($sql);

$row = $result->fetch_assoc();
$likes = $row['likes'];
$likes = $likes + 1;
$sql2 = "UPDATE post_reply SET likes='$likes' WHERE id='$postToReplyToID'";
  $result2 = $conn->query($sql2);
 

    $sql3 = "INSERT INTO likes_reply (uid, post_id) 
    VALUES (?, ?);";
