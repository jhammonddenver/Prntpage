  ...
  $laddress = $ladd1." ".$ladd2.", ".$lcity.", ".$lstate.", ".$lcountry.", ".$lzip; 
    ...
    VALUES (?, ?, ?,  ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          ...
          mysqli_stmt_bind_param($stmt, "issssiiisssssssddsssssiis", $id, $ltype, $lcat, $ldesc, $ltitle, $lmonthly, $lbed, $lbath, $laddress, $ladd1, $ladd2, $lapt, $lcity, $lstate, $lzip, $llat, $llong, $lcountry, $lcemail, $lcphone, $pic, $lavail, $ldep, $lsize, $lmeasure);
