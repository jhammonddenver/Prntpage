...
<div class="row col-12 justify-content-center">
    ...
    <h2 class="page__title text-center">Recommended For You</h2>
...
$sql2 = "SELECT * FROM items ORDER BY `created` DESC LIMIT 3";
...
<div class='d-flex flex-wrap flex-md-nowrap col-12 float-left'>
                                        ...
                                        <div class='float-left product-prev col-12 '>  
                                                          ...
                                                          <a class='col-2 btn btn-link'  href='item.php?id=".$row2["id"]."
                                               ...
                                               <a href='item.php?id=".$row2["id"]."
                                                ...
                                                ' >
                                                     ...
                                                     <br><p>  <img alt='' style='width:250px; height:180px;' class='rounded img-fluid'  src='items/photos/" . $row2["main_pic"] . "'>
                                                          </a></p> <p>" . $row2["add2"]. " <br>
     ...
     ?>
       ...
       <div class="col-12 col-sm catalog-item catalog-item_more">
                                <a href="items-map.php" class="catalog-more">
    ...
    <h2 class="page__title text-center">Newest For Sale</h2>
     <div class=" catalog-list">
...
$sql2 = "SELECT * FROM items WHERE sale_rent='sale' ORDER BY `created` DESC LIMIT 3";
$result2 = $conn->query($sql2);
...
<div class='d-flex flex-wrap flex-md-nowrap col-12 float-left'>
    ...
    <h2 class="page__title text-center">For Sale Near You
</h2>
     <div class=" catalog-list">
                            <div class="row col-12 ">
...
<div class='d-flex flex-wrap flex-md-nowrap col-12 float-left'>
    ...
    <h2 class="page__title text-center">Our Favorites
</h2>
     <div class=" catalog-list">
                            <div class="row col-12 ">
