     ...
     <div class="container">
                <nav aria-label="breadcrumb" role="navigation">
                     <ol class="breadcrumb">
                       ...
                       <li class="breadcrumb-item active" aria-current="page">Vehicles For Rent</li>
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-map" href="vehicles-rent.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-list" href="vehicles-rent-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Vehicles For Rent</h3> </center>
...
<a href="#" class="col-2 btn btn-send" style="max-height:1.5rem;padding:0px"><font color="#fff" style="font-size=".09rem">Save Search</font></a>
    	...
    	<?php 
			require 'vehicles-rent-class.php';
			$edu = new education;
...
$sql2 = "SELECT * FROM transport WHERE cat='Vehicles For Rent'";
