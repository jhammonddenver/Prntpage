...
include 'includes/header2.php';
 ...
 include 'includes/navbar-map.php';
                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="entire-house.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="entire-house-map.php">Map</a>
                                </li>
                            </ul>
...
<div class='d-flex flex-wrap flex-md-nowrap col-12'>
                                        ...
                                        <div class='product-prev '>  
                                                ...
                                                ' >View</a>
                                                <a  class='col-1 btn btn-link' href='mailto:". $row2["listing_contact_email"] . "'>Contact</a><div class='product-name'>
                                                      " . $row2["name"]. "
                                                    </div>
                                               ...
                                               <a href='bnb.php?id=".$row2["id"]."'<br>
                                                   ...
                                                   <p>
                                                       <img alt='' style='max-width:350px; max-height:240px;' class='rounded img-fluid'  src='bnbs/photos/" . $row2["listing_main_photo"] . "'> </p>
