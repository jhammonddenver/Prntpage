...
?>
        ...
        <main class="page-content"> 
            ...
            <form action="includes/upload-prop-main.inc.php" method="post" enctype="multipart/form-data">
...
<button onclick="location.href='add-property-finish.php'" type="button" class="btn btn-send">
     Finish</button>
