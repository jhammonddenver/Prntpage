...
?>
        ...
        <main class="page-content"> 
            ...
            <form action="includes/pets-upload.inc.php" method="post" enctype="multipart/form-data">
...
<button onclick="location.href='add-pet-finish.php'" type="button" class="btn btn-send">
     Finish</button>
