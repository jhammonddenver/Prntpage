                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="film.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="film-map.php">Map</a>
                                </li>
                            </ul>
                      <center>  <h3>Film</h3> </center>
     ...
     <label class="checkbox-label">
                                         ...
                                         <label class="checkbox-label">
                                           ...
                                           <label class="checkbox-label">
                                                        <input type="checkbox" class="checkbox-input">
                                                        <span class="checkbox-indicator"></span>
                                                        <span class="checkbox-description checkbox-description_light">Goverment</span>
                                                    </label>           
...
$sql2 = "SELECT * FROM jobs WHERE type='Film'";
