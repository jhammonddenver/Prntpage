                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-list" href="long-term-rentals.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-map" href="long-term-rentals-map.php">Map</a>
                                </li>
                            </ul>
                                        ...
                                        <div class='product-prev '>  
                                               ...
                                               <a href='listing.php?id=".$row2["id"]."
                                                ...
                                                ' >
                                                     ...
                                                     <br><p>  <img alt='' style='max-width:350px; max-height:240px;' class='rounded img-fluid'  src='properties/photos/" . $row2["listing_main_photo"] . "'>
