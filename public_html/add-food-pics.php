...
?>
        ...
        <main class="page-content"> 
            ...
            <form action="includes/upload-food-main.inc.php" method="post" enctype="multipart/form-data">
...
<button onclick="location.href='add-food-finish.php'" type="button" class="btn btn-send">
     Finish</button>
