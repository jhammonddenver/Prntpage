...
if (isset($_POST['reply-submit'])) {
   ...
   $sqlReplyMessage = "INSERT INTO messages (msg_from, msg_to, msg_sub, msg_body, msg_read, type) 
    VALUES (?, ?, ?, ?, ?, ?);";
...
$stmt = mysqli_stmt_init($conn);
        ...
        if (!mysqli_stmt_prepare($stmt, $sqlReplyMessage)) {
          ...
          mysqli_stmt_bind_param($stmt, "iissis", $id, $replyTo, $subject, $reply, $read, $type);
...
<section class="page-tab">
  ...
  <section class="page-content page-content-message">
    <div class="container">
      ...
      <?php
     $sql5 = "SELECT DISTINCT * FROM messages WHERE msg_to='$id' AND type='Personal'  ORDER BY msg_from ASC ";
    ...
    echo"
                      ...
                      <li class='messager'>
                       <form class='m-0 p-0 form' action='m2.php' method='post'>
    ...
    while($row7 = $result7->fetch_assoc()) {
        ...
        $sql8 = "SELECT * FROM users WHERE idUsers='$senderid'";
          ...
          <div class="messager">
           ...
           if ($selectedUser == null){
            echo'<h2 class="col-12 text-center" >Select sender to see messages.</h2>';   
                ...
                $sql18 = "SELECT * FROM messages WHERE msg_to='$id' AND msg_from='$selectedUser' OR msg_from='$id' AND msg_to='$selectedUser' ORDER BY sent_on DESC";
 ...
 {              
  ...
  $result19 = $conn->query($sql19);
        ...
        echo 'You have no messages';
          ...
          <input type="hidden" name="subject" id="subject" value="RE:'.$row18['msg_sub'].'">
