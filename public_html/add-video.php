        ...
        <main class="page-content"> 
            ...
            <div class="add-listing">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="page__title text-center">Add Video</h2>
                        </div>
                    </div>
...
<form class="form" action="includes/new-vid.inc.php" method="post" enctype="multipart/form-data">
    ...
    <input type="text"  name="vid_cat" class="form-control" >
    ...
    <input type="text" name="vid_type" class="form-control" >
    ...
    <input type="text" name="vid_title" class="form-control"  required></div> 

   <div class="form-group">
     <label class="label">Keywords:(Seperate by commas)</label><br>
    
    <input type="text" name="vid_keywords" class="form-control" >
     ...
     <textarea class="form-control" id="field-9" name="vid_disc"  required></textarea></div>   
   ...
   <div class="form-group">
   <label class="label">I want to be paid for views of this video:</label><br>
   
    <select class="form-control custom-select" name="profit">
  ...
  <label class="label">Select Video:</label><br>
    <input type="file" name="fileToUpload" id="fileToUpload">
     </div>

    <button type="submit" class="btn btn-send" name="vid-submit">Submit</button>
