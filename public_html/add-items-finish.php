                            ...
                            <div class="row mt-4 mb-5">
                                <div class="col-3 col-sm-2 col-md-4 col-lg-4">
                                    <ul class="nav nav-tabs flex-column" id="myTabSteps" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link d-flex align-items-center  active save" id="step-4-tab" data-toggle="tab" href="#step-4" role="tab" aria-controls="step-4" aria-selected="false">
                               ...
                               <h1>You Have Completed Your Listing</h1>         
                                        
                              <video width="640" height="480"  controls autoplay loop>
  
                                <source src="images/fireworks.mp4" type="video/mp4">
                                <source src="images/fireworks1.webm" type="video/webm">
                              </video>  
