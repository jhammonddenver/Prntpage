                ...
                <div class="row align-items-center col-12 mb-4 mb-lg-0">
                    <div class="col-2 col-md-3">
                        <ul class=" page-view nav float-left filter-list">
                                 <li class=" nav-item">
                                    <a class="nav-link view-map" href="automotive-services.php">List</a>
                                </li> 
                                <li class="  nav-item">
                                    <a class="nav-link view-list" href="automotive-services-map.php">Map</a>
                                </li>
                            </ul>
...
<a href="#" class="col-2 btn btn-send"><font color="#fff">Search</font></a>
    	...
    	<?php 
			require 'automotive-services-class.php';
			$edu = new education;
